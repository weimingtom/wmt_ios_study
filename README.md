...
## How to solve iOS 15.8 device debugging problem, weibo record  
...
```
* Go to (or go inside XcodeXXX.app if renamed) /Applications/Xcode.app/Contents/Developer/Platforms/iPhoneOS.platform/DeviceSupport,     
...
* MGEM2, 1.4 GHz, i5, 4GB ram, 500GB harddisc
